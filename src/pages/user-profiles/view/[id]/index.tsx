...
import { useUserProfileFindFirst, useRoqClient } from 'lib/roq';
...
function UserProfileViewPage() {
  ...
  const { data, error, isLoading } = useUserProfileFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('user_profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/user-profiles/edit/${id}`} passHref legacyBehavior>
                    <Button
